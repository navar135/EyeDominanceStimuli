...
async function experimentInit() {
  ...
  for (var i = 0, _pj_a = 14; (i < _pj_a); i += 1) {
...
function contAveragingLoopBegin(contAveragingLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisContAveraging of contAveraging) {
...
function contTrialsLoopBegin(contTrialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisContTrial of contTrials) {
...
function redoContAdjLoopBegin(redoContAdjLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisRedoContAdj of redoContAdj) {
...
function adjustContrastLoopBegin(adjustContrastLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisAdjustContrast of adjustContrast) {
...
function defineEyeLoopBegin(defineEyeLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisDefineEye of defineEye) {
...
function instBR_drift_sess1LoopBegin(instBR_drift_sess1LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisInstBR_drift_sess1 of instBR_drift_sess1) {
...
function binRiv_trials_sess1LoopBegin(binRiv_trials_sess1LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisBinRiv_trials_sess1 of binRiv_trials_sess1) {
...
function drift_BR_sess1LoopBegin(drift_BR_sess1LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisDrift_BR_sess1 of drift_BR_sess1) {
...
function test_2LoopBegin(test_2LoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisTest_2 of test_2) {
      ...
      test_2LoopScheduler.add(colorCodeRoutineBegin(snapshot));
      test_2LoopScheduler.add(colorCodeRoutineEachFrame());
      test_2LoopScheduler.add(colorCodeRoutineEnd());
      const driftTestLoopScheduler = new Scheduler(psychoJS);
      test_2LoopScheduler.add(driftTestLoopBegin(driftTestLoopScheduler, snapshot));
      test_2LoopScheduler.add(driftTestLoopScheduler);
      test_2LoopScheduler.add(driftTestLoopEnd);
...
function driftTestLoopBegin(driftTestLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisDriftTest of driftTest) {
...
function trialsLoopBegin(trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisTrial of trials) {
      ...
      trialsLoopScheduler.add(t1DriftLoopBegin(t1DriftLoopScheduler, snapshot));
      trialsLoopScheduler.add(t1DriftLoopScheduler);
      trialsLoopScheduler.add(t1DriftLoopEnd);
...
function t1DriftLoopBegin(t1DriftLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisT1Drift of t1Drift) {
...
function decDriftLoopBegin(decDriftLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisDecDrift of decDrift) {
...
function incDriftLoopBegin(incDriftLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisIncDrift of incDrift) {
...
function constDriftLoopBegin(constDriftLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisConstDrift of constDrift) {
...
function startBlindSpotRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of startBlindSpotComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function findBlindSpotRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of findBlindSpotComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function checkForRestartRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of checkForRestartComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function goodJob_prepForExpRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of goodJob_prepForExpComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function gratingContrastRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of gratingContrastComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function gratingCodeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of gratingCodeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function bothContrastRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of bothContrastComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function contrastTrialsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of contrastTrialsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function finalContRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of finalContComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function binRivInst_sess1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of binRivInst_sess1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function binRivRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of binRivComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function colorCodeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of colorCodeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function testCursorRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of testCursorComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function gradDecRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of gradDecComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function gradIncRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of gradIncComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function changeDirRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of changeDirComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trialConstRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of trialConstComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function nextTrialRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of nextTrialComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
